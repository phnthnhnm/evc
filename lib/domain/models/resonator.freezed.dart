...
mixin _$Resonator {
 ...
 String get id; String get name; int get stars; Attribute get attribute; Weapon get weapon; String get iconAsset; String get portraitAsset; List<Stat> get usableStats;@JsonKey(includeIfNull: false) EchoSet? get savedEchoSet; List<String> get teams;@JsonKey(includeIfNull: false) Map<String, String>? get teamApiNames; String? get erImportance;@JsonKey(name: 'damageSplit') Map<String, double>? get damageSplit;@JsonKey(name: 'teamER') Map<String, dynamic>? get teamER;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Resonator&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.stars, stars) || other.stars == stars)&&(identical(other.attribute, attribute) || other.attribute == attribute)&&(identical(other.weapon, weapon) || other.weapon == weapon)&&(identical(other.iconAsset, iconAsset) || other.iconAsset == iconAsset)&&(identical(other.portraitAsset, portraitAsset) || other.portraitAsset == portraitAsset)&&const DeepCollectionEquality().equals(other.usableStats, usableStats)&&(identical(other.savedEchoSet, savedEchoSet) || other.savedEchoSet == savedEchoSet)&&const DeepCollectionEquality().equals(other.teams, teams)&&const DeepCollectionEquality().equals(other.teamApiNames, teamApiNames)&&(identical(other.erImportance, erImportance) || other.erImportance == erImportance)&&const DeepCollectionEquality().equals(other.damageSplit, damageSplit)&&const DeepCollectionEquality().equals(other.teamER, teamER));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,stars,attribute,weapon,iconAsset,portraitAsset,const DeepCollectionEquality().hash(usableStats),savedEchoSet,const DeepCollectionEquality().hash(teams),const DeepCollectionEquality().hash(teamApiNames),erImportance,const DeepCollectionEquality().hash(damageSplit),const DeepCollectionEquality().hash(teamER));

@override
String toString() {
  return 'Resonator(id: $id, name: $name, stars: $stars, attribute: $attribute, weapon: $weapon, iconAsset: $iconAsset, portraitAsset: $portraitAsset, usableStats: $usableStats, savedEchoSet: $savedEchoSet, teams: $teams, teamApiNames: $teamApiNames, erImportance: $erImportance, damageSplit: $damageSplit, teamER: $teamER)';
}
...
@useResult
$Res call({
 String id, String name, int stars, Attribute attribute, Weapon weapon, String iconAsset, String portraitAsset, List<Stat> usableStats,@JsonKey(includeIfNull: false) EchoSet? savedEchoSet, List<String> teams,@JsonKey(includeIfNull: false) Map<String, String>? teamApiNames, String? erImportance,@JsonKey(name: 'damageSplit') Map<String, double>? damageSplit,@JsonKey(name: 'teamER') Map<String, dynamic>? teamER
});
...
/// Create a copy of Resonator
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? stars = null,Object? attribute = null,Object? weapon = null,Object? iconAsset = null,Object? portraitAsset = null,Object? usableStats = null,Object? savedEchoSet = freezed,Object? teams = null,Object? teamApiNames = freezed,Object? erImportance = freezed,Object? damageSplit = freezed,Object? teamER = freezed,}) {
  return _then(Resonator(
...
as List<String>,teamApiNames: freezed == teamApiNames ? _self.teamApiNames : teamApiNames // ignore: cast_nullable_to_non_nullable
as Map<String, String>?,erImportance: freezed == erImportance ? _self.erImportance : erImportance // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  int stars,  Attribute attribute,  Weapon weapon,  String iconAsset,  String portraitAsset,  List<Stat> usableStats, @JsonKey(includeIfNull: false)  EchoSet? savedEchoSet,  List<String> teams, @JsonKey(includeIfNull: false)  Map<String, String>? teamApiNames,  String? erImportance, @JsonKey(name: 'damageSplit')  Map<String, double>? damageSplit, @JsonKey(name: 'teamER')  Map<String, dynamic>? teamER)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Resonator() when $default != null:
return $default(_that.id,_that.name,_that.stars,_that.attribute,_that.weapon,_that.iconAsset,_that.portraitAsset,_that.usableStats,_that.savedEchoSet,_that.teams,_that.teamApiNames,_that.erImportance,_that.damageSplit,_that.teamER);case _:
  return orElse();
...
class _Resonator extends Resonator {
  const _Resonator({required this.id, required this.name, this.stars = 5, required this.attribute, required this.weapon, required this.iconAsset, required this.portraitAsset,  List<Stat> usableStats = const [], @JsonKey(includeIfNull: false) this.savedEchoSet,  List<String> teams = const [], @JsonKey(includeIfNull: false)  Map<String, String>? teamApiNames, this.erImportance, @JsonKey(name: 'damageSplit')  Map<String, double>? damageSplit, @JsonKey(name: 'teamER')  Map<String, dynamic>? teamER}): _usableStats = usableStats,_teams = teams,_teamApiNames = teamApiNames,_damageSplit = damageSplit,_teamER = teamER,super._();
...
@override@JsonKey() List<String> get teams {
 ...
 final  Map<String, String>? _teamApiNames;
@override@JsonKey(includeIfNull: false) Map<String, String>? get teamApiNames {
  final value = _teamApiNames;
  if (value == null) return null;
  if (_teamApiNames is EqualUnmodifiableMapView) return _teamApiNames;
  // ignore: implicit_dynamic_type
...
/// Create a copy of Resonator
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? stars = null,Object? attribute = null,Object? weapon = null,Object? iconAsset = null,Object? portraitAsset = null,Object? usableStats = null,Object? savedEchoSet = freezed,Object? teams = null,Object? teamApiNames = freezed,Object? erImportance = freezed,Object? damageSplit = freezed,Object? teamER = freezed,}) {
...
as List<String>,teamApiNames: freezed == teamApiNames ? _self._teamApiNames : teamApiNames // ignore: cast_nullable_to_non_nullable
as Map<String, String>?,erImportance: freezed == erImportance ? _self.erImportance : erImportance // ignore: cast_nullable_to_non_nullable
