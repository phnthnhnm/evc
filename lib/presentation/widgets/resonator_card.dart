...
class _ResonatorCardState extends State<ResonatorCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color scoreColor = overallTier != null
        ? AppColors.tierColor(overallTier)
        : Colors.grey;
    ...
    const Color baseBg = Color(0xFF181A20);
    const Color hoverBg = Color(0xFF202228);
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          Tooltip(
                            message: widget.resonator.attribute.label,
                            child: Container(
                              width: 36,
                              height: 36,
                              decoration: BoxDecoration(
                              ...
                              child: Image.asset(
                                widget.resonator.attribute.assetPath,
                                width: 28,
                                height: 28,
                              ),
                            ),
                          ...
                          Tooltip(
                            message: widget.resonator.weapon.label,
                            child: Container(
                              width: 36,
                              height: 36,
                              decoration: BoxDecoration(
                              ...
                              alignment: Alignment.center,
                              child: Image.asset(
                                widget.resonator.weapon.assetPath,
                                width: 28,
                                height: 28,
